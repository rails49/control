...
The startup order is `lib/startup.py`'s, stated there with its reason, and
this app takes it as it comes: one document, and the row it adopts is the
facing it already owns, waited for there and ended by the row landing or by a
stop.
